...
public class CityHash {
  ...
  public static long stringCityHash64(String str){
    return cityHash64(str.getBytes(), 0, str.length());
  }

  public static int stringCityHash32(String str){
    return (int)cityHash64(str.getBytes(), 0, str.length());
  }

  public static long[] stringCityHash128(String str){
    return cityHash128(str.getBytes(), 0, str.length());
  }
